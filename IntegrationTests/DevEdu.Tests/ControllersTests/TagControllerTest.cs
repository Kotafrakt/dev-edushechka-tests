...
namespace DevEdu.Tests.ControllersTests
{
    public class TagControllerTest : BaseControllerTest
    {
        ...
        public void GetAllTags_NoEntries_ListTagDto<T>(T roles)
        {
            ...
            var result = response.Data;
            response.StatusCode.Should().Be(HttpStatusCode.OK);
            foreach (var i in ids) result.Should().Contain(x => x.Id == i);
        }

        [TestCaseSource(typeof(UserData), nameof(UserData.SignInByRolesWithoutStudentAndTutor))]
        public void GetTagById_TagDoesntExist_EntityNotFoundResponseReceived<T>(T roles)
        {
            //Given
            var userInfo = _authenticationFacade.RegisterNewUserAndSignIn(roles);
            var tagId = 0;
        ...
        [TestCaseSource(typeof(UserData), nameof(UserData.SignInByRolesWithoutStudentAndTutor))]
        public void UpdateTag_TagDoesntExist_EntityNotFoundResponseReceived<T>(T roles)
        {
            //Given
            var userInfo = _authenticationFacade.RegisterNewUserAndSignIn(roles);
            var tagId = 0;
        ...
        [TestCaseSource(typeof(UserData), nameof(UserData.SignInByRolesWithoutStudentAndTutor))]
        public void DeleteTag_TagDoesntExist_EntityNotFoundResponseReceived<T>(T roles)
        {
            //Given
            var userInfo = _authenticationFacade.RegisterNewUserAndSignIn(roles);
            var tagId = 0;
        ...
        public void AddTag_TagDto_AuthorizationExceptionResponseReceived<T>(T roles)
        {
            //Given
            var userInfo = _authenticationFacade.RegisterNewUserAndSignIn(roles);
            _endPoint = AddTagEndpoint;
        ...
        [TestCaseSource(typeof(UserData), nameof(UserData.SignInByRolesWithStudentAndTutor))]
        public void DeleteTag_TagId_AuthorizationExceptionResponseReceived<T>(T roles)
        {
            //Given
        ...
        [TestCaseSource(typeof(UserData), nameof(UserData.SignInByRolesWithStudentAndTutor))]
        public void UpdateTag_TagDto_Id_AuthorizationExceptionResponseReceived<T>(T roles)
        {
            //Given
            var tokenAdmin = _authenticationFacade.SignInByAdmin();
            var result = _tagFacade.AddTag(tokenAdmin);
        ...
        [TestCaseSource(typeof(UserData), nameof(UserData.SignInByRolesWithoutStudentAndTutor))]
        public void AddTag_InvalidTagDto_ValidationExceptionResponseReceived<T>(T roles)
        {
            //Given
            var userInfo = _authenticationFacade.RegisterNewUserAndSignIn(roles);
            _endPoint = AddTagEndpoint;
